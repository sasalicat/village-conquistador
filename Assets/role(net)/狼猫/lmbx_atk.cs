...
public class lmbx_atk : MonoBehaviour, CDEquipment
{

    public const float CD = 0.6f;//0.5f;
    ...
    public void trigger(Dictionary<string, object> args)
    {
        ...
        Vector3 tragetPos = getVector.getOriginalInitPoint(origenPlayerPosition, mousePosition, new Vector3(0, -2, 0));//獲得相對座標
        //制造子弹物件
        ...
        int num = Attribute.GetAttackDamageNum(80, u.power);
    ...
    {
        //初始化赋值
        missilePraf = table.MissileList[27];
