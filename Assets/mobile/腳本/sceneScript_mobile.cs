...
public class sceneScript_mobile : sceneScript {
    ...
    public override void onStart(fsynManager_local manager)
    {
        ...
        ((mobile_fsyn_manager_local)manager).createMainRole(0,mainSkin,new List<int>{0,2,0,0,0},Vector2.zero,true);
        //((mobile_fsyn_manager_local)manager).createEnemy(0, new List<int> { 0 }, new Vector2(5, 5), "嘍嘍", "你的末日", "mb_ai_normalEnemy", new enemyInfo(), 1);
