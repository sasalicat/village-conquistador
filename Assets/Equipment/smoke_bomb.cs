...
public class smoke_bomb : MonoBehaviour, CDEquipment
{
    ...
    public void trigger(Dictionary<string, object> args)
    {
        ...
        ((mis_smoke_bomb)missile).origenPlayerPosition = origenPlayerPosition;
        ((mis_smoke_bomb)missile).mousePosition = mousePosition;
        ((mis_smoke_bomb)missile).missilePraf2 = missilePraf2;
    ...
    {
        missilePraf = table.MissileList[10];
        missilePraf2 = table.MissileList[11];
